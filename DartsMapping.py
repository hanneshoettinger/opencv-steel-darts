...
def getTransformedLocation(x_coord, y_coord, calData):
    try:
        ...
        # ToDo: idea for second camera -> transform complete image and overlap
        # both images to find dart location?
        ...
        dart_loc = cv2.perspectiveTransform(
            dart_loc_temp, calData.transformation_matrix)
