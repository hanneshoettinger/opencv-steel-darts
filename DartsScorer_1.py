...
def game_on():
    ...
    t = Thread(target=get_darts, args=(cam_R, cam_L, calData_R, calData_L, player, GUI))
    t.start()
...
# Create Buttons
imag_calib = Button(None, text="Calibrate", fg="black", font="Helvetica 26 bold", command=calibrate_gui)
back_gnd.create_window(20, 200, window=imag_calib, anchor='nw')

newgame = Button(None, text="Game On!", fg="black", font="Helvetica 26 bold", command=game_on)
